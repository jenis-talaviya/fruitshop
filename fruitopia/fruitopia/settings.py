...
SECRET_KEY = 'django-insecure-e6qo8&3m8@_*bq-z)u-03_!p)%#xh!vz5j5v#4uia9x*tihf7#'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'jenistalaviya404@gmail.com'
EMAIL_HOST_PASSWORD = 'zghoimvlnpzerzkv'


SECRET_KEY = 'your_secret_key'  # Should be the same as your Django SECRET_KEY
